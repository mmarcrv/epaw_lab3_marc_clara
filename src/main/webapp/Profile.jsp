...
<div id="${user.id}" class="w3-container w3-card w3-round w3-white w3-section w3-center">
  ...
  <hr>
  <button class="w3-button w3-theme w3-margin-right"><i class="fa fa-pencil"></i> Edit Profile</button>
  <button class="w3-button w3-border w3-margin-bottom"><i class="fa fa-user-plus"></i> Follow / Unfollow</button>
 </div>
<br>
</c:when>
<c:otherwise>
